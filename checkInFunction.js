...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const topPasswords = new Set([
    ...
    "111111", "qwerty123", "iloveyou", "password123", "000000", "zxcvbnm", "asdfghjkl",
    "sunshine", "121212", "dragon", "princess", "qwertyuiop", "987654321", "football",
    "baseball", "starwars", "123qwe", "shadow", "superman", "696969", "qazwsx", "michael",
    "football1", "159753", "batman", "access", "master", "jessica", "7777777", "hunter",
    "123abc", "andrew", "tigger", "test", "thomas", "love", "soccer", "computer", "whatever",
    "harley", "buster", "george", "222222", "jordan", "ashley", "fuckyou", "baseball1",
    "666666", "charlie", "robert", "pepper", "maggie", "cookie", "dakota", "mickey", "232323",
    "summer", "snoopy", "ginger", "joseph", "chelsea", "orange", "maverick", "nicole",
    "daniel", "babygirl", "lovely", "jasmine", "brandon", "112233", "anthony", "peanut",
    "bubbles", "angel", "william", "cricket", "hello", "scooby", "rainbow", "102030",
    "justin", "flower", "fish", "cheese", "amanda", "michelle",
  ]);
  ...
  const generateNickname = () => {
    const nouns = [
      "fox", "owl", "lion", "wolf", "cat", "bear", "eagle", "whale", "shark", "lynx",
    ];
    const adjectives = [
      "quick", "brave", "smart", "cool", "sneaky", "bright", "bold", "calm", "swift", "strong",
    ];
